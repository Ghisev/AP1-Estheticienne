 ...
 */
final class Version20241021132146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis ADD user_id_id INT NOT NULL, ADD date DATETIME NOT NULL, CHANGE avis texte LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis DROP user_id_id, DROP date, CHANGE texte avis LONGTEXT NOT NULL');
    }
}
